...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				glow: '0 0 15px rgba(149, 84, 255, 0.3), 0 0 30px rgba(149, 84, 255, 0.1)',
				'glow-pink': '0 0 15px rgba(255, 64, 142, 0.3), 0 0 30px rgba(255, 64, 142, 0.1)',
				'glow-blue': '0 0 15px rgba(51, 195, 240, 0.3), 0 0 30px rgba(51, 195, 240, 0.1)',
			},
			keyframes: {
				'accordion-down': {
